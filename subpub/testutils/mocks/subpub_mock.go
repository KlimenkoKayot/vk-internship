...
import (
	...
	domain "github.com/klimenkokayot/vk-internship/subpub/domain"
)
...
func (m *MockSubPub) Subscribe(subject string, cb domain.MessageHandler) (domain.Subscription, error) {
	m.ctrl.T.Helper()
